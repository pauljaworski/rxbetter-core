...
- `supabase/functions/` — edge functions (`parse-complex-wod` for WOD AI parse); deploy from core via `npx supabase functions deploy`, set `OPENROUTER_API_KEY` in Supabase secrets — not Lovable sync
