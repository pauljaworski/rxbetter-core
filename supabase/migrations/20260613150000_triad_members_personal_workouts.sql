...
comment on function public.seed_triad_member is
  'POC: provision Triad Training athlete with CrossFit + Hyrox track access for one year. Creates auth user with a random non-shared password when email provided.';
