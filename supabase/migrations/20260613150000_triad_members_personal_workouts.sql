...
comment on function public.seed_triad_member is
  'POC: provision Triad Training athlete with CrossFit + Hyrox track access for one year. Creates auth user with a randomized password when email provided; use password reset/invite for login.';
