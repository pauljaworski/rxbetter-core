...
comment on function public.seed_triad_member is
  'POC: provision Triad Training athlete with CrossFit + Hyrox track access for one year. Creates auth user when email provided; athlete must use reset/invite flow.';
