...
delete from public.programming_library_assignment where programming_id in (
  select p.id from public.programming p where p.gym_id = (select id from public.gym where name ilike 'Triad Training' limit 1)
    and p.wod_date >= '2026-06-01' and p.wod_date <= '2026-07-25' and p.source = 'gym'
...
delete from public.programming p where p.gym_id = (select id from public.gym where name ilike 'Triad Training' limit 1)
  and p.wod_date >= '2026-06-01' and p.wod_date <= '2026-07-25' and p.source = 'gym'
  and p.id::text like 'e5000000%';
