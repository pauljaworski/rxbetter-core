...
-- Paul PR/history rows are rebuilt by 03_spreadsheet_import.sql, and Triad
-- class rows are rebuilt by 04_triad_workout_trends.sql. This cleanup is
-- intentionally limited to the obsolete seeded e100... class fixture above.
