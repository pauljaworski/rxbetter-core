...
delete from public.athlete_performance where programming_id in (
  select p.id from public.programming p where p.gym_id = 'a0000000-0000-4000-8000-000000000001' and p.wod_date >= '2026-03-16' and p.wod_date <= '2026-06-30' and p.id::text like 'e3000000%'
)
and contact_id = 'c0000000-0000-4000-8000-000000000001';
delete from public.programming_line_item where programming_id in (
  select p.id from public.programming p where p.gym_id = 'a0000000-0000-4000-8000-000000000001' and p.wod_date >= '2026-03-16' and p.wod_date <= '2026-06-30' and p.id::text like 'e3000000%'
);
delete from public.programming p where p.gym_id = 'a0000000-0000-4000-8000-000000000001' and p.wod_date >= '2026-03-16' and p.wod_date <= '2026-06-30' and p.id::text like 'e3000000%';
